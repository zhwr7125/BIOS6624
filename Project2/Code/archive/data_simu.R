  ...
  for (i in 1:length(size)){
    for (j in 1:length(time)){  #n1,n2,p,beta,var_b0,var_b1,var_b0.1,var_b0.2,var_b1.1,var_b1.2
        for (q in 1:length(seed)){
          ...
          assign(paste(coco[i,j,1,1,q], sep=""),data.frame(fixef(rand.int.S),fixef(rand.int.M)))
          assign(paste(pvpv[i,j,1,1,q], sep=""),data.frame(Anova(rand.int.S,type=3)$'Pr(>Chisq)',Anova(rand.int.M,type=3)$'Pr(>Chisq)'))
          ...
          assign(paste(coco[i,j,2,1,q], sep=""),data.frame(fixef(rand.int.S),fixef(rand.int.M)))
          assign(paste(pvpv[i,j,2,1,q], sep=""),data.frame(Anova(rand.int.S,type=3)$'Pr(>Chisq)',Anova(rand.int.M,type=3)$'Pr(>Chisq)'))
          ...
          assign(paste(coco[i,j,1,2,q], sep=""),data.frame(fixef(rand.slp.S),fixef(rand.slp.M)))
          assign(paste(pvpv[i,j,1,2,q], sep=""),data.frame(Anova(rand.slp.S,type=3)$'Pr(>Chisq)',Anova(rand.slp.M,type=3)$'Pr(>Chisq)'))
          ...
          assign(paste(coco[i,j,2,2,q], sep=""),data.frame(fixef(rand.slp.S),fixef(rand.slp.M)))
          assign(paste(pvpv[i,j,2,2,q], sep=""),data.frame(Anova(rand.slp.S,type=3)$'Pr(>Chisq)',Anova(rand.slp.M,type=3)$'Pr(>Chisq)'))

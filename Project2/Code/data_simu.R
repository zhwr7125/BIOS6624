...
for (i in 1:length(size)){
  ...
  for (i in 1:length(size)){
    for (j in 1:length(time)){
          assign(paste(haha[i,j,1,1], sep=""), data_gene(n1=size[i]/2,n2=size[i]/2,p=time[j],beta=c(0, 0, 0, 0),var_b0=4,var_b1=0))
          assign(paste(haha[i,j,2,1], sep=""), data_gene(n1=size[i]/2,n2=size[i]/2,p=time[j],beta=c(2, 1, 0.5, 0.25),var_b0=4,var_b1=0))
